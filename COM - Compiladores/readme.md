...
- **Implementação de uma extensão de um compilador de SpecC para SystemC**
  - *Autor(es)/Ano:* João Guilherme Packer (Orientador: Fabiano Baldo) / 2013
  - *Link:* [https://repositorio.udesc.br/entities/publication/2a91d71a-7d3c-48a5-9c2a-f1f50fbca082](https://repositorio.udesc.br/entities/publication/2a91d71a-7d3c-48a5-9c2a-f1f50fbca082)

- **Estrutura de análise dinâmica para compiladores**
  - *Autor(es)/Ano:* Gerson Fernando Budke (Orientador: Claudio Cesar de Sá) / 2008
  - *Link:* [https://repositorio.udesc.br/handle/UDESC/18461](https://repositorio.udesc.br/handle/UDESC/18461)
